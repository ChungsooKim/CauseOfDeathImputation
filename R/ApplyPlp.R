...
covariateSummary <- function(plpData, population){
  ...
  grp_qty <- PatientLevelPrediction::bySumFf(covariates$ones, covariates$covariateId)
  ...
  lengths <- PatientLevelPrediction::bySumFf(covariates$ones, covariates$covariateId)
  sumval <- PatientLevelPrediction::bySumFf(covariates$covariateValue, covariates$covariateId)
  sumvalsquared <- PatientLevelPrediction::bySumFf(covariates$squared, covariates$covariateId)
